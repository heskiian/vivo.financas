...
import com.vivo.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.vivo.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoController {
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		Usuario usuario = usuarioService
			...
			.orElseThrow(() -> new RegraNegocioException("Usuario não encontrado por id informado. "));
